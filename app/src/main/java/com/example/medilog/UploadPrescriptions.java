...
public class UploadPrescriptions extends AppCompatActivity {
   ...
   // private ImageView IVPreviewImage;
    ...
    private final int PICK_IMAGE_GALLERY_CODE  = 200;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        databaseReference=database.getReference().child("prescription_images");;
        storageReference = firebaseStorage.getReference();

        BSelectImage = findViewById(R.id.button11);
        BUploadImage = findViewById(R.id.button12);
        IVPreviewImage = findViewById(R.id.imageView);
        progressBar = findViewById(R.id.progressBar);
        showUPloadedImages = findViewById(R.id.button14);
        profileName=(TextView) findViewById(R.id.textView7);
        ...
        showUPloadedImages.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(UploadPrescriptions.this, DownloadPrescriptionImages.class);
        ...
        if(filePath != null) {
            ...
            ref.putFile(filePath).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                    ref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                        ...
                        public void onSuccess(Uri uri) {
                            ...
                            Toast.makeText(UploadPrescriptions.this, "Image uploaded successfully", Toast.LENGTH_SHORT).show();
                ...
                public void onFailure(@NonNull Exception e) {
                    progressBar.setVisibility(View.GONE);
                    Toast.makeText(UploadPrescriptions.this, "Image uploaded failed", Toast.LENGTH_SHORT).show();
                }
            });
        }
    }
    ...
    private void checkCameraPermission(){
        if(ContextCompat.checkSelfPermission(UploadPrescriptions.this, Manifest.permission.CAMERA)
                != PackageManager.PERMISSION_GRANTED
                || ContextCompat.checkSelfPermission(UploadPrescriptions.this, Manifest.permission.WRITE_EXTERNAL_STORAGE)
                != PackageManager.PERMISSION_GRANTED ) {
            ActivityCompat.requestPermissions(UploadPrescriptions.this, new String[] {
